            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="dtsuccesdelivery.php">Sucessful Delivery</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-body">
                                    <div style="width: 100%; height: 100%;">
                                        <?php include "./pdf/succes-delivery.php"; ?>
                                        <iframe src="<?php echo $pdfUrl; ?>" style="width: 100%; height: 100%; border: none;"></iframe>
                                    </div>
                                </div>
                                <!-- Print Button -->
                                <div class="card-footer">
                                    <button onclick="printPDF()" class="btn btn-primary">Print PDF</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            function printPDF() {
                                window.frames[0].focus(); // Fokus pada frame iframe
                                window.frames[0].print(); // Cetak isi frame iframe
                            }
                        </script>
                    </div>
                    <!-- /.container-fluid -->
